The name of the project is AKAN NAMES GENERATOR. This web application deals with Ghanaian names. A user may place the day of their birth, then the program gives the output of the names.
